...
| <a name="input_lifecycle_rule_enabled"></a> [lifecycle_rule_enabled](#input_lifecycle_rule_enabled)                                     | Enable or disable lifecycle rule                                                                                                                                                                                                                                            | `string`       | `"Disabled"`       |    no    |
...
| <a name="input_versioning_enabled"></a> [versioning_enabled](#input_versioning_enabled)                                                 | A state of versioning. Versioning is a means of keeping multiple variants of an object in the same bucket                                                                                                                                                                   | `string`       | `"Enabled"`        |    no    |
